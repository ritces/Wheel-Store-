...
export declare class ProductPartsService {
    ...
    update(id: number, updateProductPartDto: UpdateProductPartDto): import(".prisma/client").Prisma.Prisma__partsClient<{
        name: string;
        id: number;
        product_id: number;
    }, never, import("@prisma/client/runtime/library").DefaultArgs>;
    remove(id: number): import(".prisma/client").Prisma.Prisma__partsClient<{
        name: string;
        id: number;
        product_id: number;
    }, never, import("@prisma/client/runtime/library").DefaultArgs>;
